...
async function writeInUserController( repoName ) {
  try {
    const content = `import { asyncHandler } from "../utils/asyncHandler.js";
...
export {
    ...
    await fs.writeFile(`${repoName}/src/controllers/user.controller.js`, content);
  } catch (err) {
    console.log(err);
  }
}
export default writeInUserController
...
async function writeinPackageLock( repoName ) {
  try {
    const content = `{
  ...
  "packages": {
    ...
    "node_modules/mongoose-aggregate-paginate-v2": {
      "version": "1.0.7",
      "resolved": "https://registry.npmjs.org/mongoose-aggregate-paginate-v2/-/mongoose-aggregate-paginate-v2-1.0.7.tgz",
      "integrity": "sha512-Xij2wux3xs9yfXhV9d7M1P92WJsz39fyNJWyVAcSDhVO4HZnoM2zz03b2ZLCT13ha5TJL9uPM+jw1Sj2IqjHAQ==",
      "engines": {
        "node": ">=4.0.0"
      }
    },
  ...
  `
    await fs.writeFile(`${repoName}/package-lock.json`, content);
  } catch (err) {
    console.log(err);
  }
}

export default writeinPackageLock